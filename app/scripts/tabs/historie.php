...
if(isset($_GET['odeslani']) && $_GET['typ'] == 0)
{
    ...
    else
    {
        ...
        // Grafy
        echo "<div class='graf' id='graf-historie-teplota'>";
        require './scripts/grafy/teplota/historie.php';
        echo "</div>";

        if($vlhkomer == 1 && $r['MIN(nejnizsi_vlhkost)'] != 0)
        {
            echo "<div class='graf' id='graf-historie-vlhkost'>";
            require './scripts/grafy/vlhkost/historie.php';
            echo "</div>";
        }
